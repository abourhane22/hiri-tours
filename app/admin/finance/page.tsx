  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <FinanceCard href="/admin/finance/pilotage" icon={<Target className="size-6 text-terracotta-700" />} title="Pilotage" desc="Objectifs annuels, cibles de rentabilité et de gestion." />
