/* =========================================================
   HIRI TOURS — Pictogrammes filaires (SVG inline, trait 1.7)
   Remplacent les emojis pour un rendu identique sur tous les appareils.
   Usage : icon("surf")  →  <svg class="icon">…</svg>
   Dans le HTML statique : <span data-icon="surf"></span> (rempli par applyIcons)
   ========================================================= */
...
const ICONS = {
  ...
  heart:  '<path d="M12 20s-7.5-4.6-9-9.2C2 7.6 4 5 6.8 5c2 0 3.6 1.1 5.2 3.2C13.6 6.1 15.2 5 17.2 5 20 5 22 7.6 21 10.8c-1.5 4.6-9 9.2-9 9.2Z"/>',
  ...
  chat:   '<path d="M4 5.5h16v11H9l-5 4Z"/><path d="M8 9.5h8M8 12.5h5"/>',
  ...
  send:   '<path d="M3.5 11.5 20.5 4l-6.5 16.5-3-7Z"/><path d="M20.5 4 11 13.5"/>',
  ...
  ticket: '<path d="M3.5 8h17v2.6a1.9 1.9 0 0 0 0 3.8V17h-17v-2.6a1.9 1.9 0 0 0 0-3.8Z"/><path d="M14.5 8v9" stroke-dasharray="2.4 2.4"/>',
  star:   '<path d="M12 3.5l2.5 5.2 5.7.7-4.2 3.9 1.1 5.6L12 16.2l-5.1 2.7 1.1-5.6-4.2-3.9 5.7-.7Z"/>',
  logout: '<path d="M9.5 4H5v16h4.5"/><path d="m14.5 8 4 4-4 4"/><path d="M18.5 12H9"/>',
  check:  '<path d="M5 12.5l4.5 4.5L19 7"/>',
  download:'<path d="M12 4v11"/><path d="M7.5 11.5 12 15.5l4.5-4"/><path d="M4.5 19.5h15"/>',
...
/* Remplit les <span data-icon="…"> du HTML statique */
function applyIcons(scope) {
  (scope || document).querySelectorAll("[data-icon]").forEach(el => { el.innerHTML = icon(el.dataset.icon); });
}
